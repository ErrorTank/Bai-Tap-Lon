...
const dbUtils = [{
    ...
    query: "CREATE TABLE `olympic`.`registrationcandidate`(`rcID` NVARCHAR(10) NOT NULL,  `address` NVARCHAR(200) NOT NULL, `sID` NVARCHAR(10) NOT NULL, `name` NVARCHAR(50) NOT NULL, `phone` NVARCHAR(20) NOT NULL, `email` NVARCHAR(100) NOT NULL, `contestID` NVARCHAR(50) NOT NULL, `CMT` NVARCHAR(20) NOT NULL , `gender` INT(1) NOT NULL  , `username` NVARCHAR(50) NULL  , `password` NVARCHAR(50) NULL  , `dob` DATETIME NOT NULL, PRIMARY KEY(`rcID`)) ENGINE = InnoDB;"
  }, {
    name: "Create Admin",
    ...
    query: "CREATE TABLE `olympic`.`examDatecandidate`(`examDateID` VARCHAR(10) NOT NULL, `cID` VARCHAR(10) NOT NULL, `SBD` VARCHAR(10) NOT NULL, PRIMARY KEY(`examDateID`, `cID`)) ENGINE = InnoDB;"
  }, {
