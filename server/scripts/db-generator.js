...
const dbUtils = [{
    ...
    query: "CREATE TABLE `olympic`.`contest` (`contestID` NVARCHAR(10) NOT NULL , `contestName` NVARCHAR(50) NOT NULL , `subjectID` NVARCHAR(10) NOT NULL , `fee` NVARCHAR(20) NOT NULL , `orgLocationID` NVARCHAR(10) NOT NULL , `content` NVARCHAR(100) NULL , `canSeeResolve` BOOLEAN NOT NULL , PRIMARY KEY (`contestID`), UNIQUE (`contestName`)) ENGINE = InnoDB;"
  }, {
    name: "Create examDate table",
    query: "CREATE TABLE `olympic`.`examDate` (`examDateID` NVARCHAR(10) NOT NULL , `start` DATETIME NOT NULL ,`stop` DATETIME NOT NULL, `content` NVARCHAR(100) NULL , `contestID` NVARCHAR(10) NOT NULL , `roomID` NVARCHAR(10) NOT NULL , `supervisorID` NVARCHAR(10) NOT NULL , PRIMARY KEY (`examDateID`)) ENGINE = InnoDB;"
  }, {
